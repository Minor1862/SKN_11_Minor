...
# CSV 파일 설정
csv_file = open('kia_EV_faq.csv', mode='w', newline='', encoding='utf-8')
...
def crawl_page():
    ...
    for idx, question_btn in enumerate(question_btns):
        ...
        try:
            ...
            # CSV 파일에 데이터 작성
            csv_writer.writerow(['Kia', question, answers])
...
# URL을 설정하여 페이지를 호출
url = "https://www.kia.com/kr/vehicles/kia-ev/guide/faq"  # 카테고리 구분 없이 FAQ 페이지만 호출
